...
PP=16
GPUS_PER_NODE=8
MICRO_BATCH=1 # per dp batch size.
GLOBAL_BATCH=64 # micro * dp * grad_accum
RANK=1
N_NODES=2
ADDR=172.20.12.190
EXP_NAME=$1
...
# /scratch/scai/msr/aiy217586/llama-2-70b-hf_meditron
# LOAD_CHECKPOINT_PATH=/scratch/scai/phd/aiz218326/llama-2-70b-hf-tp-16-pp-1
...
# EXTRA_ARGS='--vocab_file=/scratch/scai/phd/aiz218326/llama-2-70b-hf-tp-16-pp-1/tokenizer.model --use_rms_norm --glu_activation swiglu --no_tie_embed_logits --no_new_tokens --clip_grad 1.0'

EXTRA_ARGS='--vocab_file=/scratch/cse/btech/cs1200448/llama-weights/7b/tokenizer.model --use_rms_norm --glu_activation swiglu --no_tie_embed_logits --num_layers 80 --hidden_size 8192 --num_attention_heads 64  --num_attention_heads_kv 8 --use_rms_norm --glu_activation swiglu --no_tie_embed_logits --ffn_hidden_size 28672 --no_new_tokens'
