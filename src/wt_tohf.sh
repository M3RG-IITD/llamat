...
python3 ../Megatron-LLM/weights_conversion/megatron_to_hf.py --input_dir $2 --output_dir $2 --model $3 --vocab_file /scratch/cse/btech/cs1200448/hf-to-meditron-weights/7b/tokenizer.model --num_output_shards 3 #--vocab_extra_ids_list "<|im_start|>,<|im_end|>"