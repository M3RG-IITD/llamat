...
def load_all_questions(file_path):
    try:
        data_with_questions = load_jsonl(file_path)
...
def main():
    ...
    if uploaded_file is not None:
        ...
        data_with_questions = load_all_questions(val_file_path)
    ...
    for model_name in selected_models:
        if model_name in data and selected_task in data[model_name] and selected_dataset in data[model_name][selected_task]:
            for entry in data[model_name][selected_task][selected_dataset]:
                entry['question'] = data_with_questions[entry['sample_idx']]['question']
